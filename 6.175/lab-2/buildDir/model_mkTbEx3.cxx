...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_tb_randomA_initialized__h397;
	 tUInt8 DEF_INST_top_DEF_tb_randomB_initialized__h773;
	 ...
	 DEF_INST_top_DEF_tb_randomA_initialized__h397 = INST_top.INST_tb_randomA_initialized.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1 = !DEF_INST_top_DEF_tb_randomA_initialized__h397;
	 ...
	 DEF_INST_top_DEF_tb_randomB_initialized__h773 = INST_top.INST_tb_randomB_initialized.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_tb_randomB_every_1 = !DEF_INST_top_DEF_tb_randomB_initialized__h773;
	 INST_top.DEF_WILL_FIRE_RL_tb_randomB_every_1 = INST_top.DEF_CAN_FIRE_RL_tb_randomB_every_1;
	 INST_top.DEF_x__h955 = INST_top.INST_tb_cycle.METH_read();
	 INST_top.DEF_tb_cycle_5_EQ_128___d17 = (INST_top.DEF_x__h955) == 128u;
	 INST_top.DEF_tb_cycle_5_EQ_0___d16 = (INST_top.DEF_x__h955) == 0u;
	 INST_top.DEF_CAN_FIRE_RL_tb_test = INST_top.DEF_tb_cycle_5_EQ_0___d16 || (INST_top.DEF_tb_cycle_5_EQ_128___d17 || (DEF_INST_top_DEF_tb_randomA_initialized__h397 && DEF_INST_top_DEF_tb_randomB_initialized__h773));
...
void MODEL_mkTbEx3::get_version(char const **name, char const **build)
{
  *name = "2023.01";
  *build = "52adafa5";
}
...
time_t MODEL_mkTbEx3::get_creation_time()
{
  ...
  /* Wed Jan 31 12:04:16 UTC 2024 */
  return 1706702656llu;
}
