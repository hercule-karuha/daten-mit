...
static void schedule_posedge_CLK(tSimStateHdl simHdl, void *instance_ptr)
	 ...
	 tUInt8 DEF_INST_top_DEF_tb_randomA_initialized__h971;
	 tUInt8 DEF_INST_top_DEF_tb_randomB_initialized__h1384;
	 INST_top.DEF_x__h315 = INST_top.INST_dut_i.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_dut_mulStep = (INST_top.DEF_x__h315) < 32u;
	 ...
	 DEF_INST_top_DEF_tb_randomA_initialized__h971 = INST_top.INST_tb_randomA_initialized.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1 = !DEF_INST_top_DEF_tb_randomA_initialized__h971;
	 INST_top.DEF_WILL_FIRE_RL_tb_randomA_every_1 = INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1;
	 DEF_INST_top_DEF_tb_randomB_initialized__h1384 = INST_top.INST_tb_randomB_initialized.METH_read();
	 INST_top.DEF_CAN_FIRE_RL_tb_randomB_every_1 = !DEF_INST_top_DEF_tb_randomB_initialized__h1384;
	 ...
	 INST_top.DEF_x__h6291 = INST_top.INST_tb_read_count.METH_read();
	 INST_top.DEF_tb_read_count_4_EQ_128___d55 = (INST_top.DEF_x__h6291) == 128u;
	 INST_top.DEF_CAN_FIRE_RL_tb_read = ((INST_top.DEF_x__h315) == 32u && INST_top.INST_tb_operands_fifo.METH_i_notEmpty()) && !(INST_top.DEF_tb_read_count_4_EQ_128___d55);
	 ...
	 INST_top.DEF_x__h1790 = INST_top.INST_tb_feed_count.METH_read();
	 INST_top.DEF_x_wget__h1223 = INST_top.INST_tb_randomB_zaz.METH_wget();
	 INST_top.DEF_x_wget__h809 = INST_top.INST_tb_randomA_zaz.METH_wget();
	 INST_top.DEF_v__h1390 = INST_top.INST_tb_randomB_zaz.METH_whas() ? INST_top.DEF_x_wget__h1223 : 0u;
	 INST_top.DEF_v__h977 = INST_top.INST_tb_randomA_zaz.METH_whas() ? INST_top.DEF_x_wget__h809 : 0u;
	 INST_top.DEF_IF_tb_randomA_zaz_whas__4_THEN_tb_randomA_zaz__ETC___d33 = (INST_top.DEF_v__h977) == 2147483648u;
	 INST_top.DEF_IF_tb_randomB_zaz_whas__0_THEN_tb_randomB_zaz__ETC___d34 = (INST_top.DEF_v__h1390) == 2147483648u;
	 INST_top.DEF_CAN_FIRE_RL_tb_feed = ((DEF_INST_top_DEF_tb_randomA_initialized__h971 && (DEF_INST_top_DEF_tb_randomB_initialized__h1384 && ((INST_top.DEF_IF_tb_randomA_zaz_whas__4_THEN_tb_randomA_zaz__ETC___d33 || INST_top.DEF_IF_tb_randomB_zaz_whas__0_THEN_tb_randomB_zaz__ETC___d34) || INST_top.INST_tb_operands_fifo.METH_i_notFull()))) && (!((INST_top.DEF_x__h1790) == 128u) && (INST_top.DEF_x__h315) == 33u)) && !(INST_top.DEF_CAN_FIRE_RL_tb_randomA_every_1 || INST_top.DEF_CAN_FIRE_RL_dut_mulStep);
	 ...
	 {
	   INST_top.INST_dut_tp.rst_tick__clk__1((tUInt8)1u);
...
time_t MODEL_mkTbEx5::get_creation_time()
{
  ...
  /* Wed Feb  7 15:36:45 UTC 2024 */
  return 1707320205llu;
}
