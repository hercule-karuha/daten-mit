...
class MOD_mkTbEx5 : public Module {
 ...
 public:
  ...
  tUInt32 DEF_x__h6291;
  tUInt32 DEF_x__h1790;
  tUInt32 DEF_x__h315;
  tUInt32 DEF_x_wget__h1223;
  tUInt32 DEF_x_wget__h809;
  tUInt32 DEF_v__h1390;
  tUInt32 DEF_v__h977;
  tUInt8 DEF_tb_read_count_4_EQ_128___d55;
  tUInt8 DEF_IF_tb_randomA_zaz_whas__4_THEN_tb_randomA_zaz__ETC___d33;
  tUInt8 DEF_IF_tb_randomB_zaz_whas__0_THEN_tb_randomB_zaz__ETC___d34;
 
 /* Local definitions */
 private:
  tUInt32 DEF_new_value__h1359;
  tUInt32 DEF_new_value__h945;
  tUInt32 DEF_x__h297;
  tUInt32 DEF_w__h227;
  tUInt32 DEF_x__h393;
