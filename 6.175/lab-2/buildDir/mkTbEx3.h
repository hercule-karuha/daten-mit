...
#ifndef __mkTbEx3_h__
#define __mkTbEx3_h__
...
/* Class declaration for the mkTbEx3 module */
class MOD_mkTbEx3 : public Module {
 ...
 /* Constructor */
 public:
  MOD_mkTbEx3(tSimStateHdl simHdl, char const *name, Module *parent);
 ...
 public:
  ...
  void dump_VCD(tVCDDumpType dt, unsigned int levels, MOD_mkTbEx3 &backing);
  void vcd_defs(tVCDDumpType dt, MOD_mkTbEx3 &backing);
  void vcd_prims(tVCDDumpType dt, MOD_mkTbEx3 &backing);
};

#endif /* ifndef __mkTbEx3_h__ */
